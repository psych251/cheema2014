...
imp = imputeEM(pisa_5persample, impute.ncomps = 1, pca.ncomps = 2, CV = TRUE, Init = "mean",
...
method4_em <- function (data) {

}

pre <- prelim.norm(as.matrix(pisa_5persample)) #arranges data in a matrix that can be used by the em function
